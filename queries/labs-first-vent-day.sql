...
DROP MATERIALIZED VIEW IF EXISTS labsfirstventday CASCADE;
CREATE materialized VIEW labsfirstventday AS
SELECT
...
( -- begin query that extracts the data
  ...
  AND le.charttime between (tc.first_vent_starttime - interval '6' hour) and (tc.first_vent_starttime + interval '1' day)
  -- ---
  AND le.ITEMID in
    (
