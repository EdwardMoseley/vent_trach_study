...
DROP MATERIALIZED VIEW IF EXISTS weightfirstventday CASCADE;
CREATE MATERIALIZED VIEW weightfirstventday as
with ce as
(
    SELECT
      c.icustay_id
    ...
    inner join trach_cohort ie
        ...
        and c.charttime <= ie.first_vent_starttime + interval '1' day
        and c.charttime > ie.first_vent_starttime - interval '1' day -- some fuzziness for admit time
...
(
    ...
    inner join trach_cohort ie
        ...
        and ec.charttime < ie.first_vent_starttime + interval '1' day
    where
